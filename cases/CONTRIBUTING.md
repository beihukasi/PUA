...
> 💡 **推荐编辑器**：Windows 用记事本（右键 → 打开方式 → 记事本）或下载 [VS Code](https://code.visualstudio.com/)，Mac 用自带的文本编辑。
...
scenario: "酒吧"            # 选一个：酒吧/咖啡馆/街头/书店/社交活动/健身房/线上/其他
difficulty: "中级"          # 初级/中级/高级
result: "成功"              # 成功/失败/部分成功
tags: [开场, DHV, kino]     # 选相关标签（方便别人搜索）
---
```
...
3. ✅ **关键动作加粗** — `**我牵了她的手**` 这样读者一眼看到转折点
4. ✅ **复盘要具体** — 不要说 "我做得不够好"，要说 "我在开场后没有及时切换话题，导致冷场"
5. ❌ 不要编（这是知识库，不是小说）
6. ❌ 不要暴露真实姓名、照片、联系方式
...
2. 你会看到一个黄色的提示条 **"This branch is 1 commit ahead of beihukasi:main"**
...
## 🕶️ 想匿名？
在案例文件顶部的 frontmatter 里写 `contributor: "匿名"`，你的 GitHub 用户名不会出现在案例中。
